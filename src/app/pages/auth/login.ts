...
@Component({
    ...
    styles: `
        ::ng-deep button.p-ripple.p-button.p-component{
            width:50%;
            margin:0 auto;
        }
    `,
                    ...
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            <svg viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="mb-8 w-16 shrink-0 mx-auto">
                                ...
                                />
                                <mask id="mask0\_1413\_1551" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="8" width="54" height="11">
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Hospital Management</div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                                <!-- Show loading indicator when login is processing -->
                                <p-button 
                                    label="Sign In" 
                                    Class="w-full mt-3 d-block text-center" 
                                    [loading]="isLoading"
                                    (click)="onLogin()">
                                </p-button>
                            </div>
...
export class Login {
    ...
    onLogin() {
        ...
        this.http.post<any>('http://localhost:4200/api/auth/login', loginPayload)
            .subscribe({
                next: (response) => {
